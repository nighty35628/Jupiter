...
function cfgWith(types: CustomMemoryTypeConfig[]): JupiterConfig {
...
describe("custom memory types (#709)", () => {
  ...
  beforeEach(() => {
    home = mkdtempSync(join(tmpdir(), "jupiter-memtype-home-"));
    projectRoot = mkdtempSync(join(tmpdir(), "jupiter-memtype-proj-"));
