/** #1074 — the desktop sidecar must survive an unhandled rejection / uncaught exception rather than exit(1) (which Tauri surfaces as "jupiter exited (code 1)" and forces a full reconnect). */
