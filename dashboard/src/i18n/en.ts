export const en = {
  app: {
    ...
    yolo: {
      toast: "Switched to full-control permission",
    },
    cmd: {
      abort: "Abort",
      btw: "BTW",
  ...
  chat: {
    ...
    editGateTitle: "permission mode — Shift+Tab cycles in TUI",
    ...
    editYoloTitle: "Full control — edits AND shell auto-run without prompts",
    railSession: "Session",
    railTurns: "turns",
  ...
  overview: {
    ...
    standaloneDesc:
      "Read-only disk view. Start /dashboard from inside jupiter code for live session state, MCP, and tools.",
    cockpit: "Cockpit",
    balance: "balance",
    tokens7d: "tokens · 7d",
    cacheHit: "cache hit",
    ...
    noSession: "No live session — /dashboard from inside jupiter code to attach.",
    ...
    active: "active",
    allUp: "all up",
    yoloWarning: "full-control permission enabled",
    checking: "checking",
    latest: "latest",
  },
  usage: {
    ...
    noData: "No usage data yet — run a turn in jupiter chat / code / run and refresh.",
  ...
  sessions: {
    ...
    attachRequired:
      "Live session operations need an attached CLI session. Launch via jupiter chat or open the dashboard from inside a TUI session.",
    activeChip: "active",
    activePill: "active",
  },
  tools: {
  ...
  permissions: {
    ...
    yoloTitle: "Full-control permission",
    yoloDesc:
      "Every shell command auto-runs without prompting. Switch back to Review to re-enable prompts.",
    project: "project",
    builtin: "builtin",
    ...
    standaloneWarning:
      "Mutations require /dashboard from inside an active jupiter code session — standalone jupiter dashboard can't tell which project's allowlist to edit.",
  },
  mcp: {
    loading: "loading MCP…",
    ...
    saved: "saved",
    savedRestart: "saved — restart jupiter code to bridge this server",
    ...
    whyUnbridgedDesc:
      "This spec lives in your config.json but isn't bridged into the live session. MCP servers attach when jupiter code starts; the dashboard alone can't spawn the child process.",
    whyUnbridgedHint: "To activate: restart jupiter code, then refresh this dashboard.",
    bridgeFailed: "Bridge failed",
    bridgeFailedTitle: "bridge failed · in config",
    bridgeFailedHint:
      "Jupiter tried to bridge this server and the attempt errored. Common causes: wrong URL, missing auth header, upstream 404/5xx, missing local command. Fix and restart jupiter code to retry.",
    ...
    marketplaceEnvHint:
      "Set these in your shell before next `jupiter code` so the bridged server can authenticate.",
    marketplaceRestartHint:
      "Spec written to ~/.jupiter/config.json. Restart `jupiter code` to bridge the server (live hot-reload is on the roadmap).",
  },
  memory: {
    ...
    pickDesc: "Project JUPITER.md is committable; global notes live in ~/.jupiter/memory/.",
    chars: "{count} chars",
    saved: "saved {scope}",
  ...
  hooks: {
    ...
    colScript: "script",
    noProject: "No active project — open /dashboard from jupiter code to edit project hooks.",
  ...
  skills: {
    ...
    builtinDesc:
      "Built-in skills ship with Jupiter; the model picks them up automatically. To customize, create a project- or global-scoped skill with the same name.",
  ...
  system: {
    ...
    built: "● built",
    none: "— none",
    runIndex: "run jupiter index to build",
    usageLog: "usage log",
  ...
  semantic: {
    ...
    installOllamaDesc:
      "Jupiter doesn't run package managers for you. Install Ollama first, then come back:",
    ...
    apiUrl: "API URL",
    apiKey: "API key",
    apiKeyStoredNote: "API key is stored in ~/.jupiter/config.json — do not share that file.",
    ...
    remoteProviderDesc:
      "Configure the full OpenAI-compatible embeddings URL here. Jupiter will send requests exactly to the URL you provide.",
    ollama: "ollama",
    binary: "binary",
    found: "found",
    missing: "missing",
  ...
  editMode: {
    ...
    yolo: "Full control",
    yoloHint: "Full-control permission · edits AND shell auto-run without prompts",
  },
};
