...
const FEATURES = [
  ...
  },
  {
    ...
    desc: {
      zh: '.jupiter/skills/<name>.md，frontmatter 支持 runAs: subagent + allowed-tools 隔离运行。',
      en: 'Drop a Markdown file in `.jupiter/skills/<name>.md`; frontmatter supports `runAs: subagent` and `allowed-tools` for isolated execution.',
    },
  },
  {
    title: { zh: 'Replay & Events', en: 'Replay & events' },
    en: 'jupiter replay / events / stats',
    desc: {
