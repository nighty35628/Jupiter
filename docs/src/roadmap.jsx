// Roadmap — based on real Jupiter release notes & wishlist discussion
...
const ROADMAP = [
  ...
  },
  {
    ...
    items: [
      ...
      { zh: 'install-source-aware jupiter update', en: 'install-source-aware `jupiter update`' },
  ...
  },
  {
    ...
    state: 'plan',
    items: [
      { zh: 'jupiter init · 项目脚手架 CLI', en: 'jupiter init · project scaffolder CLI' },
