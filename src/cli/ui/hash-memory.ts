...
const PROJECT_HEADER = `# Jupiter project memory
...
const GLOBAL_HEADER = `# Jupiter global memory

Cross-project notes the user pinned via the \`#g\` prompt prefix. Loaded
into every Jupiter session's prefix regardless of working directory.
...
export const GLOBAL_MEMORY_DIR = ".jupiter";
export const GLOBAL_MEMORY_FILE = "JUPITER.md";
