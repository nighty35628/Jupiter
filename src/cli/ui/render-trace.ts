/** Render frequency + duration counters, gated by `JUPITER_TRACE_RENDERS` so prod paths stay free. */
...
const enabled = ((): boolean => {
  const v = process.env.JUPITER_TRACE_RENDERS;
...
/** True when `JUPITER_TRACE_RENDERS` is set — skip expensive wiring otherwise. */
