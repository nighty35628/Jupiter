...
export interface McpToolSchema {
  /** JSON Schema — compatible with Jupiter's tools.ts JSONSchema shape. */
  type?: string;
...
export interface McpTool {
  name: string;
  description?: string;
  /** MCP calls this `inputSchema`. Jupiter's `parameters` field is the same concept. */
...
/** MCP result content is an array of typed blocks. Jupiter consumes only text for now — image blocks get stringified with a placeholder. */
...
/** Current MCP protocol version Jupiter is coded against. */
