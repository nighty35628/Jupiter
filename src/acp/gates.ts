/** Bridges Jupiter's internal `PauseGate` requests onto ACP `session/request_permission` round-trips. */

import { resolveApprovalPrompt, toApprovalPrompt } from "@jupiter/core-utils";
...
export async function requestPermissionForGate(
  ...
  | import("@jupiter/core-utils").ConfirmationChoice
  | import("@jupiter/core-utils").PlanVerdict
  | import("@jupiter/core-utils").CheckpointVerdict
  | import("@jupiter/core-utils").RevisionVerdict
  | import("@jupiter/core-utils").ChoiceVerdict
> {
