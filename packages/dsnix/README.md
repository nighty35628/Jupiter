...
Short alias for [`jupiter`](https://www.npmjs.com/package/jupiter) — the DeepSeek-native coding agent.

This package is a thin shim. Installing or running `dsnix` resolves to the same `jupiter` CLI, just under a shorter command name.
...
```bash
npx jupiter@latest code my-project
```
