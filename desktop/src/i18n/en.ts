export const en = {
  ...
  pets: {
    ...
    selectedUnavailable: "The selected custom pet is unavailable. Companion Cube is shown temporarily.",
  ...
  app: {
    ...
    rpcNotStarted: "Jupiter core is not running. The command was not sent. Restart Jupiter to continue.",
    rpcDeliveryUnknown:
