export const en = {
  webAuth: {
    ...
    hint: "Use the full link from the startup terminal, or create a new link in Settings > General > Web access in a connected browser. Links expire after five minutes and work once.",
    linkLabel: "Pairing link",
    connect: "Connect",
    connecting: "Connecting...",
    required: "This browser is not paired, or its session has expired.",
    expired: "This pairing link has expired or was already used. Create a new link.",
    invalidLink: "Enter a complete pairing link containing #bootstrap=.",
    wrongServer: "This link belongs to a different address. Open the full link in the address bar instead.",
    unavailable: "Cannot connect to Jupiter. Check that the Web service is running, then retry.",
  },
  palette: {
  ...
  composer: {
    ...
    askMode: "Ask",
    askModeActive: "Ask · Next",
    askModeAria: "Answer the next message directly",
    askModeHint: "Next message answers directly without tools, library, or project context.",
    askModeNotice: "Next message will answer directly without tools, library, or project context.",
    askModeNoticeClose: "Turn off ask mode",
  ...
  pets: {
    enableTitle: "Desktop pet",
    enableHint: "Show a floating companion that follows activity across conversations.",
    enabled: "On",
    disabled: "Off",
    previewTitle: "Preview",
    presetsTitle: "Built-in companions",
    presetsHint: "Choose one companion. Only the selected animation atlas is loaded.",
    customTitle: "Custom",
    customHint: "Add a v2 pet package to this folder, then refresh.",
    openFolder: "Open pet folder",
    refresh: "Refresh pets",
    scanning: "Scanning custom pets...",
    noCustomPets: "No valid custom pets found.",
    selectedUnavailable:
      "The selected custom pet is unavailable. Companion Cube is shown temporarily.",
    interact: "Wave to desktop pet",
    currentTask: "Current conversation",
    openTask: "Open the conversation linked to this pet",
    dragHint: "Drag to move · Select to open the conversation",
    activityTray: "Conversation activity",
    contextMenu: "Pet menu",
    contextOpenTask: "Open current conversation",
    contextInteract: "Say hello",
    contextResetPosition: "Reset position",
    contextSettings: "Pet settings",
    contextHide: "Hide pet",
    statusWaiting: "Needs your input",
    statusBlocked: "Needs attention",
    statusReady: "Ready for review",
    statusWorking: "Using tools",
    statusThinking: "Thinking",
    statusIdle: "Ready",
    companionCubeName: "Companion Cube",
    companionCubeDescription: "A pixel companion from Aperture Science.",
    jupiterSproutName: "Jupiter Sprout",
    jupiterSproutDescription: "A bright orbital seedling.",
    origamiFoxName: "Origami Fox",
    origamiFoxDescription: "A precise paper-folded scout.",
    cloudsmithName: "Cloudsmith",
    cloudsmithDescription: "A tiny cloud engineer with sunny tools.",
    lanternJellyName: "Lantern Jelly",
    lanternJellyDescription: "A calm floating light for long sessions.",
    copperwingName: "Copperwing",
    copperwingDescription: "A careful brass-and-teal mechanical beetle.",
    inkDragonName: "Ink Dragon",
    inkDragonDescription: "A small graphite dragon with an emerald spark.",
  },
  settings: {
    title: "Settings",
    close: "close",
    ...
    showAiVisibleDetails: "AI visible content",
    showAiVisibleDetailsHint:
      "Show a read-only summary of content that may be available to the AI in the current chat.",
    shown: "shown",
    hidden: "hidden",
    enabled: "enabled",
    disabled: "disabled",
    ...
    libraryRetrievalModeHint: "Controls when Jupiter consults saved library sources during a turn.",
    ...
    webNotificationsHint: "Notify this browser when a task finishes or needs your approval.",
    webNotificationsEnable: "Enable on this device",
    webNotificationsEnabled: "Enabled",
    webNotificationsBlocked: "Blocked by browser",
    webAccessSection: "Web access",
    webPairDevice: "Pair another device",
    webPairDeviceHint: "Create a single-use link that expires in five minutes.",
    webPairDeviceCreate: "Create and copy link",
    webControl: "Control is active elsewhere",
    webControlHint: "Observers stay live, but only one device can send commands at a time.",
    webTakeControl: "Take control",
    webThisDevice: "this device",
    webRevokeDevice: "Revoke",
    closeToQuit: "quit",
    ...
    webSearchApiKey: {
      ...
      "deepseek-native": "DeepSeek native search API key",
    },
    deepSeekNativeCredentialReusingMain: "Ready — securely reusing the official DeepSeek key.",
    deepSeekNativeCredentialDedicated: "Ready — dedicated search key configured.",
    deepSeekNativeCredentialNeeded:
      "A dedicated key is required because the main model uses a custom, Azure, or GLM endpoint.",
    deepSeekNativeCredentialUnavailable: "Set a DeepSeek search key before using this provider.",
    deepSeekNativeCredentialFailed: "Last native search failed: {message}",
    baseUrl: "Provider base URL",
    baseUrlHint:
      "HTTPS Chat Completions base URL. Local private-network HTTP endpoints are also allowed.",
    workspace: "Workspace",
    workspaceHint:
    ...
    pageComponentsLabel: "Components",
    pageComponentsDesc: "Browser automation, document preview, and media processing dependencies",
    ...
    pagePetsLabel: "Pets",
    pagePetsDesc: "Desktop companion, presets, and custom pet packages",
    ...
    storageHint: "Only Jupiter-owned data is shown here. Workspace project files are review-only.",
    ...
    usageSection: "Usage",
    contextDiagnosticsTitle: "Context diagnostics",
    contextDiagnosticsHint: "Open this page after a turn to inspect the active session prompt mix.",
    contextDiagnosticsEmpty: "No context diagnostics yet",
    contextDiagnosticsLastCall: "last prompt {prompt}t · hit {hit} / miss {miss}",
    contextDiagnosticsTokenMix:
      "system {system} · tools {tools} · log {log} · memory {memory} · summary {summary}",
    contextDiagnosticsTools: "{count} tools · {messages} log messages · session cache {cache}%",
    contextDiagnosticsTopTools: "tool hot spots: {tools}",
    contextDiagnosticsNoTopTools: "No tool result hot spots yet.",
    usageHistoryTitle: "Usage history",
    usageHistoryHint: "Historical token and cost totals from the local usage log.",
    usageHistoryRecords: "{count} records indexed",
    usageHistoryEmpty: "No usage records loaded",
    usageHistoryEmptyHint: "Run a conversation once, then reopen this page.",
    usageHistoryNoMonth: "No month selected",
    usageHistoryMonthHint: "Switch between this month and previous months.",
    usageHistoryMode: "Usage grouping",
    usageHistoryModeHint: "Group the selected month by day, week, or month.",
    usageHistoryDailyUsage: "Daily usage",
    usageHistoryWeeklyUsage: "Weekly usage",
    usageHistoryMonthlyUsage: "Monthly usage",
    usageHistoryDay: "Day",
    usageHistoryWeek: "Week",
    usageHistoryMonth: "Month",
    usageHistoryPeriod: "Period",
    usageHistoryTurns: "Turns",
    usageHistoryTokens: "Tokens",
    usageHistoryCost: "Cost",
    usageHistoryTotalTokens: "Selected month tokens",
    usageHistoryTotalCost: "Selected month cost",
    usageHistoryCostHint: "Converted for display only.",
    usageHistoryNoRows: "No usage in this period",
    aboutSection: "About",
    ...
    providerSection: "Model provider",
    providerProtocol: "API protocol",
    providerProtocolHint: "Use DeepSeek extensions only when the endpoint supports them.",
    providerProtocolAuto: "Auto detect",
    providerProtocolDeepSeek: "DeepSeek Chat Completions",
    providerProtocolOpenAi: "OpenAI-compatible Chat Completions",
    providerActive: "Current provider: {provider}",
    providerNewChatsHint:
      "Changes apply to new conversations. Existing conversations stay on their original provider.",
    providerTest: "Test connection",
    providerLocalOnly: "Managed on the Jupiter host",
    providerLocalOnlyHint:
      "Provider addresses and credentials are hidden from remote Web clients. Configure them in Desktop or local Web.",
    ...
    optionalComponentsTitle: "Local components",
    optionalComponentsHint:
      "Jupiter uses components already installed on this computer first, and does not download Chromium automatically.",
    optionalComponentsRefresh: "Detect again",
    optionalComponentsEmpty: "No component detection results yet",
    optionalComponentRecommended: "Recommended",
    optionalComponentAvailable: "Available",
    optionalComponentMissing: "Missing",
    optionalComponentUnsupported: "Unsupported",
    optionalComponentOpenInstall: "Open install page",
    optionalCapabilityBrowserAutomation: "Browser automation",
    optionalCapabilityOfficePreview: "Office document preview",
    ...
    modelVision: "This model supports image input",
    imageTransport: "Image transport",
    imageTransportAuto: "Auto (official Files / inline)",
    imageTransportInline: "Inline images",
  ...
  effort: {
    offDesc: "disable DeepSeek thinking",
  ...
  app: {
    ...
    rpcNotStarted:
      "Jupiter core is not running. The command was not sent. Restart Jupiter to continue.",
    rpcDeliveryUnknown:
      "Connection to Jupiter core was interrupted. Command delivery is unknown; sending is paused. Restart Jupiter before continuing.",
  ...
  cards: {
    ...
    skillName: "Using skill",
    subagentSkillName: "Using subagent skill",
    skillTask: "Task",
  ...
  contextPanel: {
    ...
    git: {
      ...
      commitPlaceholder: "Leave empty to auto-generate…",
      commitAll: "Commit",
      push: "Push",
      createPr: "Create PR",
    ...
    cacheKey: "cache",
    freeKey: "free",
    aiVisibleTitle: "AI visible content",
    aiVisibleObserved: "last turn",
    aiVisiblePendingShort: "pending",
    aiVisibleHint:
      "Read-only summary of content that may be available to the AI. Long chats can be compressed or partly omitted.",
    aiVisiblePending: "available after a turn",
    aiVisibleIncluded: "included",
    aiVisibleNotObserved: "not observed",
    aiVisibleConversation: "Conversation",
    aiVisibleConversationValue: "{count} messages",
    aiVisibleConversationHint: "Recent messages and summaries may be used.",
    aiVisibleSystemRules: "System rules",
    aiVisibleSystemRulesHint: "Only the category is shown here, not the rules text.",
    aiVisibleTools: "Connected tools",
    aiVisibleToolsValue: "{count} tools",
    aiVisibleToolsEmpty: "none active",
    aiVisibleMcpServers: "{ready}/{count} connected tool servers",
    aiVisibleMcpNotBridged: "{ready}/{count} tool servers, not active in this session",
    aiVisibleBuiltinTools: "Built-in tools are available when the model needs them.",
    aiVisibleFiles: "Files",
    aiVisibleFilesValue: "{count} tracked",
    aiVisibleFilesEmpty: "none tracked",
    aiVisibleFilesDetail: "{modified} modified by this chat",
    aiVisibleMemory: "Saved memory",
    aiVisibleMemoryValue: "{count} entries",
    aiVisibleMemoryEmpty: "none saved",
    aiVisibleMemoryOff: "disabled",
    aiVisibleMemoryHint: "Contents are not shown in this summary.",
    aiVisibleWorkspace: "Workspace",
    aiVisibleWorkspaceValue: "selected",
    aiVisibleWorkspaceEmpty: "not selected",
    aiVisibleWorkspaceHint: "Workspace path and project rules may affect context.",
    ...
    subagentSidebarHint:
      "The full child transcript stays in the subagent session. This tab tracks the live run without switching the main chat.",
  ...
  thread: {
    ...
    historyFolded: "Older details are folded for display. The session record was not deleted.",
    loadFullTurn: "Load full turn",
    loadingFullTurn: "Loading full turn...",
  },
  live: {
