export const en = {
  ...
  settings: {
    ...
    editModeYoloDesc: "Run all tools automatically; use carefully",
    budget: "Budget cap",
  ...
  editMode: {
    ...
    yoloDesc: "all tools run automatically",
    ...
    yoloHint: "Full access · all tools run automatically, use carefully",
  },
  markdown: {
