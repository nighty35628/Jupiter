...
export const de: typeof en = {
  ...
  composer: {
    ...
    askMode: "Fragen",
    askModeActive: "Fragen · Nächste",
    askModeAria: "Die nächste Nachricht direkt beantworten",
    askModeHint:
      "Die nächste Nachricht wird direkt ohne Tools, Bibliothek oder Projektkontext beantwortet.",
    askModeNotice:
      "Die nächste Nachricht wird direkt ohne Tools, Bibliothek oder Projektkontext beantwortet.",
    askModeNoticeClose: "Fragemodus deaktivieren",
  ...
  pets: {
    ...en.pets,
    enableTitle: "Desktop-Tier",
    enableHint: "Zeigt einen schwebenden Begleiter für Aktivitäten in mehreren Unterhaltungen.",
    enabled: "Ein",
    disabled: "Aus",
    previewTitle: "Vorschau",
    presetsTitle: "Integrierte Begleiter",
  ...
  settings: {
    ...
    showAiVisibleDetails: "Für KI sichtbare Inhalte",
    showAiVisibleDetailsHint:
      "Zeigt eine schreibgeschützte Zusammenfassung der Inhalte, die die KI im aktuellen Chat nutzen könnte.",
    shown: "angezeigt",
    hidden: "ausgeblendet",
    enabled: "ein",
    disabled: "aus",
    ...
    pagePetsLabel: "Tiere",
    pagePetsDesc: "Desktop-Begleiter, Vorlagen und benutzerdefinierte Pakete",
    ...
    contextDiagnosticsTitle: "Kontextdiagnose",
    contextDiagnosticsHint:
      "Öffne diese Seite nach einem Turn, um die Prompt-Zusammensetzung der aktiven Sitzung zu prüfen.",
    contextDiagnosticsEmpty: "Noch keine Kontextdiagnose",
    contextDiagnosticsLastCall: "letzter Prompt {prompt}t · hit {hit} / miss {miss}",
    contextDiagnosticsTokenMix:
      "system {system} · tools {tools} · log {log} · memory {memory} · summary {summary}",
    contextDiagnosticsTools: "{count} Tools · {messages} Log-Nachrichten · Sitzungscache {cache}%",
    contextDiagnosticsTopTools: "Tool-Hotspots: {tools}",
    contextDiagnosticsNoTopTools: "Noch keine Tool-Ergebnis-Hotspots.",
    usageHistoryTitle: "Nutzungsverlauf",
    usageHistoryHint: "Historische Token- und Kostensummen aus dem lokalen Nutzungslog.",
    usageHistoryRecords: "{count} Einträge indexiert",
    usageHistoryEmpty: "Noch keine Nutzungsdaten geladen",
    usageHistoryEmptyHint: "Starte eine Unterhaltung und öffne diese Seite erneut.",
    usageHistoryNoMonth: "Kein Monat ausgewählt",
    usageHistoryMonthHint: "Zwischen diesem Monat und vorherigen Monaten wechseln.",
    usageHistoryMode: "Nutzungsgruppierung",
    usageHistoryModeHint: "Den ausgewählten Monat nach Tag, Woche oder Monat gruppieren.",
    usageHistoryDailyUsage: "Tägliche Nutzung",
    usageHistoryWeeklyUsage: "Wöchentliche Nutzung",
    usageHistoryMonthlyUsage: "Monatliche Nutzung",
    usageHistoryDay: "Tag",
    usageHistoryWeek: "Woche",
    usageHistoryMonth: "Monat",
    usageHistoryPeriod: "Zeitraum",
    usageHistoryTurns: "Turns",
    usageHistoryTokens: "Tokens",
    usageHistoryCost: "Kosten",
    usageHistoryTotalTokens: "Tokens im ausgewählten Monat",
    usageHistoryTotalCost: "Kosten im ausgewählten Monat",
    usageHistoryCostHint: "Nur zur Anzeige umgerechnet.",
    usageHistoryNoRows: "Keine Nutzung in diesem Zeitraum",
    aboutSection: "Über",
    ...
    optionalComponentsTitle: "Lokale Komponenten",
    optionalComponentsHint:
      "Jupiter nutzt zuerst Komponenten, die bereits auf diesem Computer installiert sind, und lädt Chromium nicht automatisch herunter.",
    optionalComponentsRefresh: "Erneut erkennen",
    optionalComponentsEmpty: "Noch keine Komponenten-Erkennung",
    optionalComponentRecommended: "Empfohlen",
    optionalComponentAvailable: "Verfügbar",
    optionalComponentMissing: "Fehlt",
    optionalComponentUnsupported: "Nicht unterstützt",
    optionalComponentOpenInstall: "Installationsseite öffnen",
    optionalCapabilityBrowserAutomation: "Browser-Automation",
    optionalCapabilityOfficePreview: "Office-Dokumentvorschau",
    optionalCapabilityMediaProcessing: "Medienverarbeitung",
    optionalCapabilityOcr: "OCR",
    optionalCapabilityDocumentConversion: "Dokumentkonvertierung",
    qqSection: "QQ-Kanal",
  ...
  app: {
    ...
    rpcNotStarted:
      "Der Jupiter-Kern läuft nicht. Der Befehl wurde nicht gesendet. Starten Sie Jupiter neu, um fortzufahren.",
    rpcDeliveryUnknown:
      "Die Verbindung zum Jupiter-Kern wurde unterbrochen. Die Zustellung ist unbekannt; weitere Befehle sind angehalten. Starten Sie Jupiter neu, um fortzufahren.",
  ...
  cards: {
    ...
    errorName: "Fehler",
    searchName: "Websuche",
    skillName: "Skill wird verwendet",
    subagentSkillName: "Subagent-Skill wird verwendet",
    skillTask: "Aufgabe",
    skillRunning: "Läuft",
    skillDone: "Erledigt",
    skillFailed: "Fehlgeschlagen",
  ...
  contextPanel: {
    ...
    cacheKey: "Cache",
    freeKey: "frei",
    aiVisibleTitle: "Für KI sichtbare Inhalte",
    aiVisibleObserved: "letzter Turn",
    aiVisiblePendingShort: "ausstehend",
    aiVisibleHint:
      "Schreibgeschützte Zusammenfassung von Inhalten, die die KI nutzen könnte. Lange Chats können komprimiert oder teilweise ausgelassen werden.",
    aiVisiblePending: "nach einem Turn verfügbar",
    aiVisibleIncluded: "enthalten",
    aiVisibleNotObserved: "nicht beobachtet",
    aiVisibleConversation: "Gespräch",
    aiVisibleConversationValue: "{count} Nachrichten",
    aiVisibleConversationHint: "Aktuelle Nachrichten und Zusammenfassungen können genutzt werden.",
    aiVisibleSystemRules: "Systemregeln",
    aiVisibleSystemRulesHint: "Hier wird nur die Kategorie angezeigt, nicht der Regeltext.",
    aiVisibleTools: "Verbundene Tools",
    aiVisibleToolsValue: "{count} Tools",
    aiVisibleToolsEmpty: "keine aktiv",
    aiVisibleMcpServers: "{ready}/{count} Tool-Server verbunden",
    aiVisibleMcpNotBridged: "{ready}/{count} Tool-Server, in dieser Sitzung nicht aktiv",
    aiVisibleBuiltinTools: "Eingebaute Tools sind verfügbar, wenn das Modell sie benötigt.",
    aiVisibleFiles: "Dateien",
    aiVisibleFilesValue: "{count} verfolgt",
    aiVisibleFilesEmpty: "keine verfolgt",
    aiVisibleFilesDetail: "{modified} in diesem Chat geändert",
    aiVisibleMemory: "Gespeicherte Memory",
    aiVisibleMemoryValue: "{count} Einträge",
    aiVisibleMemoryEmpty: "keine gespeichert",
    aiVisibleMemoryOff: "deaktiviert",
    aiVisibleMemoryHint: "Inhalte werden in dieser Zusammenfassung nicht angezeigt.",
    aiVisibleWorkspace: "Workspace",
    aiVisibleWorkspaceValue: "ausgewählt",
    aiVisibleWorkspaceEmpty: "nicht ausgewählt",
    aiVisibleWorkspaceHint: "Workspace-Pfad und Projektregeln können den Kontext beeinflussen.",
