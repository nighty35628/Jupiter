...
export const I = {
  ...
  diff: (p: IconProps) => (
    <Ic {...p}>
      <path d="M7 4v11a3 3 0 0 0 3 3h2M17 20V9a3 3 0 0 0-3-3h-2" />
  ...
  link: (p: IconProps) => (
    <Ic {...p}>
      <path d="M10 14a4 4 0 0 1 0-6l3-3a4 4 0 0 1 6 6l-2 2" />
      <path d="M14 10a4 4 0 0 1 0 6l-3 3a4 4 0 0 1-6-6l2-2" />
    </Ic>
  ),
  wrench: (p: IconProps) => (
    <Ic {...p}>
  ...
  paperclip: (p: IconProps) => (
    <Ic {...p}>
      <path d="M21 12 12 21a5 5 0 0 1-7-7L14 5a3 3 0 0 1 4 4l-9 9a1 1 0 0 1-2-2l8-8" />
    </Ic>
  ),
  mic: (p: IconProps) => (
    <Ic {...p}>
  ...
  cog: (p: IconProps) => (
    <Ic {...p}>
      <path d="M12 3.6 19.2 7.8v8.4L12 20.4 4.8 16.2V7.8Z" />
  ...
  branch: (p: IconProps) => (
    <Ic {...p}>
      ...
      <path d="M6 6v12M6 14a6 6 0 0 0 6-6h4" />
    </Ic>
  ),
  at: (p: IconProps) => (
    <Ic {...p}>
      <circle cx="12" cy="12" r="4" />
      <path d="M16 8v6a3 3 0 0 0 5-2 9 9 0 1 0-4 7" />
    </Ic>
  ),
  slash: (p: IconProps) => (
    <Ic {...p}>
