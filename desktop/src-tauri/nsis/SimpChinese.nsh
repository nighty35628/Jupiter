...
LangString appRunning ${LANG_SIMPCHINESE} "Jupiter 正在运行！请先关闭它，然后重试。"
LangString appRunningOkKill ${LANG_SIMPCHINESE} "Jupiter 正在运行！$\n单击「确定」结束它"
...
LangString dontUninstall ${LANG_SIMPCHINESE} "取消更新"
LangString dontUninstallDowngrade ${LANG_SIMPCHINESE} "取消更新"
LangString failedToKillApp ${LANG_SIMPCHINESE} "无法结束 Jupiter。请先关闭它然后重试。"
LangString installingWebview2 ${LANG_SIMPCHINESE} "正在安装 WebView2…"
LangString newerVersionInstalled ${LANG_SIMPCHINESE} "系统中已安装更新版本的 ${PRODUCTNAME}。请下载最新版本，或取消此安装程序。"
LangString older ${LANG_SIMPCHINESE} "较旧的"
LangString olderOrUnknownVersionInstalled ${LANG_SIMPCHINESE} "系统上已安装 $R4 版本的 ${PRODUCTNAME}。单击「更新 Jupiter」以替换为此版本，或取消更新。"
LangString silentDowngrades ${LANG_SIMPCHINESE} "此安装程序禁用了降级，无法通过静默模式继续，请改用图形界面安装程序。$\n"
LangString unableToUninstall ${LANG_SIMPCHINESE} "无法更新！"
LangString uninstallApp ${LANG_SIMPCHINESE} "卸载 ${PRODUCTNAME}"
LangString uninstallBeforeInstalling ${LANG_SIMPCHINESE} "更新 Jupiter"
